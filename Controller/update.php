...
define('DB_NAME', 'gestionando_n');//Nombre de la base de datos
...
$query_update = $conexion-> query($cotizante);
			if ($query_update){
                echo '<script language="javascript">alert("Coizante Actualizado con Exito");window.location.href="../View/temple/Cotizantes.php"</script>';
			} else{
