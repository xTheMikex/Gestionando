                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <p class="text-muted font-14 m-b-30">
                                       Ingrese los de nuevos cotizantes, actualice los pagos y cambie el pago de un cotizante.
                                    </p>
    ...
    <div class="col-sm-12 col-md-6">
      <div id="dtBasicExample_filter" class="dataTables_filter">
        <label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dtBasicExample">
                                ...
                                <table  id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                    <tr>
                                        ...
                                        <th class="th-sm">#</th>
                                        <th class="th-sm">Afiliacion</th>
                                        <th class="th-sm">Fecha pago</th>
                                        <th class="th-sm">Valor pagado</th>
                ...
                if ($inc){
                  $consulta = "SELECT p.*, e.nombre AS Estado FROM pagos p INNER JOIN estado e ON e.id_estado=p.id_estado";
            ...
            ?>
                                    <tr>
                                        ...
                                        <td><?php echo $mostrar['fecha_pago_cuota']?></td>
                                        <td><?php echo $mostrar['valor_pagado']?></td>
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form name='formulario-js' action="../../Controller/InsertPago.php" method="POST" onsubmit='return validarfor()'>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Afiliación</label>
                              <input type="text" class="form-control" name="id_afi" id="id_afi" >
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">fecha_pago_cuota</label>
                              <input type="date" class="form-control" name="fecha_pago_cuota" id="fecha_pago_cuota">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">valor_pagado</label>
                              <input type="number" class="form-control number-only" name="valor_pagado" id="valor_pagado" onsubmit='return addemup()'>
                            </div>
            ...
            ?>
                    ...
                    <div class="modal-header">
                        ...
                        <form action="../../Controller/update.php" method="POST" >
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">id_afi</label>
                              
                              <input type="text" class="form-control" name="id_afi" id="recipient-name" value="<?php echo $mostrar['id_afi']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">fecha_pago_cuota</label>
                              <input type="text" class="form-control" name="fecha_pago_cuota" id="recipient-name" value="<?php echo $mostrar['fecha_pago_cuota']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">valor_pagado</label>
                              <input type="text" class="form-control" name="valor_pagado" id="recipient-name" value="<?php echo $mostrar['valor_pagado']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">id_estado</label>
                              <input type="text" class="form-control" name="id_estado" id="recipient-name" value="<?php echo $mostrar['id_estado']?>"></input>
                        </div>
                        <div class="modal-footer">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="form-check">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="id_pago" id="recipient-name" value="<?php echo $mostrar['id_pago']?>"></input>
