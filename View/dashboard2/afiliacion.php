...
<?php
 ...
 {    
     $id  = $_POST['id'];
     $consulta ="SELECT * FROM cotizante WHERE id_afi = '$id'";
                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <p class="text-muted font-14 m-b-30">
                                       Ingrese la información de los afiliaciones nuevas, actualice los datos y cambie la afiliacion de un cotizante.
                                    </p>
    ...
    <div class="col-sm-12 col-md-6">
      <div id="dtBasicExample_filter" class="dataTables_filter">
        <label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dtBasicExample">
                                ...
                                <table  id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                    <tr>
                                        ...
                                        <th class="th-sm">#</th>
                                        <th class="th-sm">entidad</th>
                                        <th class="th-sm">centro</th>
                                        <th class="th-sm">fecha pago</th>
                                        <th class="th-sm">total pagar</th> 
                ...
                if ($inc){
                  $consulta = "SELECT af.*, en.nombre AS entidad, c.nombre AS centro, e.nombre AS Estado FROM afiliacion af INNER JOIN entidad_administradora en ON en.id_ent=af.id_ent INNER JOIN centro c ON c.id_centro=af.id_centro INNER JOIN estado e ON e.id_estado=af.id_estado";
            ...
            ?>
                                    <tr>
                                        ...
                                        <td ><?php echo $mostrar['id_afi']?></td>
                                        <td><?php echo $mostrar['entidad']?></td>
                                        <td><?php echo $mostrar['centro']?></td>
        ...
        <li class="paginate_button page-item ">
          ...
          <li class="paginate_button page-item next" id="dtBasicExample_next">
            ...
            <!-- Earnings (Monthly) Card Example -->
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form name='formulario-js' action="../../Controller/InsertAfili.php" method="POST" onsubmit='return validarfor()'>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Entidad</label>
                              <input type="text" class="form-control" name="id_ent" id="id_ent" >
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Centro</label>
                              <input type="text" class="form-control" name="id_centro" id="id_centro">
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Fecha_pago</label>
                              <input type="date" class="form-control number-only" name="fecha_pago" id="fecha_pago" onsubmit='return addemup()'>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Total_pagar</label>
                              <input type="number" class="form-control number-only" name="total_pagar" id="total_pagar" onsubmit='return addemup()'>
                            </div>
                            <div class="form-group">
                ...
                $inc = include("../../Controller/conexion.php");
                if ($inc){
                  $consulta = "SELECT * FROM afiliacion";
                  $resultado = $conexion -> query($consulta);
                  if ($resultado){
                    while($mostrar = $resultado->fetch()){
            ...
            ?>
                    ...
                    <div class="modal-header">
                        ...
                        <form action="../../Controller/update.php" method="POST" >
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">id_ent</label>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="id_centro" id="recipient-name" value="<?php echo $mostrar['id_centro']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">fecha_pago</label>
                              <input type="text" class="form-control" name="fecha_pago" id="recipient-name" value="<?php echo $mostrar['fecha_pago']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">total_pagar</label>
                              <input type="text" class="form-control" name="total_pagar" id="recipient-name" value="<?php echo $mostrar['total_pagar']?>"></input>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">id_estado</label>
                              <input type="email" class="form-control" name="id_estado" id="recipient-name" value="<?php echo $mostrar['id_estado']?>"></input>
                            </div>    
                        </div>
                        <div class="modal-footer">
                ...
                ?>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Cambiar afiliacion</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                            <form action="../../Controller/Deleteafili.php" method="POST">
                            <div class="form-group">
                            <div class="form-check">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="id" id="recipient-name" value="<?php echo $mostrar['id_afi']?>"></input>
                                ...
                                <i  onClick="window.location='../../Controller/Deleteafili.php?rut=<?php echo $id; ?>';">
                                </i>
                                </button>
                                </div>
