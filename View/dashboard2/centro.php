                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <p class="text-muted font-14 m-b-30">
                                       Ingrese la información de los centros nuevos, actualice los datos y cambie el centro de un cotizante.
                                    </p>
        ...
        <label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dtBasicExample">
            ...
            ?>
                                    <tr>
                                        ...
                                        <td ><?php echo $mostrar['id_centro']?></td>
          ...
          <li class="paginate_button page-item next" id="dtBasicExample_next">
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form name='formulario-js' action="../../Controller/InsertCentro.php" method="POST" onsubmit='return validarfor()'>
            ...
            ?>
                    ...
                    <div class="modal-header">
                        ...
                        <form action="../../Controller/updateCentro.php" method="POST" >
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">Nombre</label>
                ...
                ?>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Cambiar Centro</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
