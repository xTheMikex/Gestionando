...
<body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    Puedes ver los usuarios que estan registrados en el sistema.
                                    </p>
    ...
    <div class="col-sm-12 col-md-6">
      ...
      <button type="button" class="btn btn-danger  "data-toggle="modal" data-target="#exampleModal3" data-whatever="@mdo">Cambiar Estado </button>
                </div>
                <div class="row">
          ...
          <li class="paginate_button page-item next" id="dtBasicExample_next">
            ...
            ?>
                    ...
                    <div class="modal-header">
                        ...
                        <form action="../../Controller/updateUs.php" method="POST" >
                        <div class="form-group">
                              <label for="recipient-name" class="col-form-label">ID</label>
                              
                              <input type="text" class="form-control" name="id" id="recipient-name" value="<?php echo $mostrar['id_usuario']?>"></input>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="usuario" id="recipient-name" value="<?php echo $mostrar['usuario']?>"></input>
                            </div>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="form-check">
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="id_us" id="recipient-name" value="<?php echo $mostrar['id_usuario']?>"></input>
                                ...
                                <div class="modal-footer">
                                <button type="submit" class="btn btn-danger btn-circle btn-lg" name="DeleteUs" id="consult" >
                                <i class="fas fa-trash" onClick="window.location='../../Controller/DeleteUs.php?rut=<?php echo $id; ?>';">
                                </i>
                                </button>
                                </div>
                            </form>
