...
<body>
              ...
              <div class="col-12">
                <div class="card">
                  <div  class="card-header">
                    <font color="#295566"><h3 >Afiliaciones</h3></font> 
                      <div class="card-body">
                  </div>
                  <a href="#addnew" class="btn btn-info" data-toggle="modal"><span class="fas fa-plus"></span>Nueva afiliación</a>
                  ...
                  <div class="card-body">
                    ...
                    <?php
                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                        <?php 
                              $sql = "SELECT af.*, en.nombre AS entidad, c.nombre AS centro, co.nombre AS nombre, e.nombre AS Estado 
                              FROM afiliacion af INNER JOIN entidad_administradora en ON en.id_ent=af.id_ent 
                              INNER JOIN centro c ON c.id_centro=af.id_centro 
                              INNER JOIN estado e ON e.id_estado=af.id_estado
                              INNER JOIN cotizante co ON co.id_cotizante=af.id_cotizante";
                              $result = db_query($sql);
                              while($row = mysqli_fetch_object($result)){
                              ?>
                              <tr>
                              <td><?php echo $row->id_afi;?></td>
                                ...
                                <td>
                            <a href="afiliaciones/editar.php?id_afi=<?php echo $row->id_afi; ?>" class="btn btn-warning btn-sm">
  ...
  <?php include('afiliaciones/AgregarModal.php'); ?>
  <script src="afiliaciones/validar.js" ></script>
  <!--  General JS Scripts -->
