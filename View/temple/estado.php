...
<body>
              ...
              <div class="col-12">
                <div class="card">
                  <div  class="card-header">
                    <font color="#295566"><h3>Estado</h3></font>
                      <div class="card-body">
                  </div>
                <a href="#addnew" class="btn btn-info" data-toggle="modal"><span class="fas fa-plus"></span>Nuevo estado</a>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                       ...
                       <?php 
                              ...
                              <td><?php echo $row->id_estado;?></td>
                                ...
                                <td>
                            <a href="estado/editar.php?id_estado=<?php echo $row->id_estado; ?>" class="btn btn-warning btn-sm">
  ...
  <?php include('estado/AgregarModal.php'); ?>
  <!-- General JS Scripts -->
