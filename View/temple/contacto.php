...
<head>
  ...
  <title>Gestionando | Contacto</title>
  <!-- General CSS Files -->
        ...
        <div class="row">
          <div class="col-12 col-md-10 offset-md-1 col-lg-10 offset-lg-1">
                    ...
                    <form method="POST">
                      <div class="form-group floating-addon">
                        ...
                        <div class="input-group">
                          ...
                          <input id="name" type="text" class="form-control" name="name" autofocus placeholder="Nombre">
                        </div>
                      </div>
                      <div class="form-group floating-addon">
                        <label>Correo</label>
                      ...
                      <div class="form-group">
                        <label>Mensaje</label>
                        <textarea class="form-control" placeholder="Escribe tu mensaje" data-height="150"></textarea>
                      </div>
            ...
            <div class="simple-footer">
              Copyright &copy; Gestionando 2020
            </div>
          </div>
        </div>
      </div>
