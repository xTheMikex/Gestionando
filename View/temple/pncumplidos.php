          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="#">Pagos No cumplidos</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <div class="col-12">
                <div class="card">
                  <div  class="card-header">
                     <font color="#295566"><h3>Pagos no cumplidos</h3></font>
                     <div class="card-body">
                  </div>
                  <a href="email-mysql/index.php" class="btn btn-primary" id="toastr-2"><i class="far fa-edit">Generar reporte.</i></a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <?php
                          ...
                          $db = $database->open();
                          try{	
                            $sql = 'SELECT * FROM pagos_nocumplidos';
