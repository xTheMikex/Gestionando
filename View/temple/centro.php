              ...
              <div class="col-12">
                <div class="card">
                  <div  class="card-header">
                    <font color="#295566"><h3 >Centros de afiliación</h3></font>  
                      <div class="card-body">
                    
                  </div>
                  <!--#295566 botones-->
                  <a href="#addnew" class="btn btn-info" data-toggle="modal"><span class="fas fa-plus"></span>Centro afiliación</a>
                  </div>
                  <div class="card-body">
                    ...
                    <?php
                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php 
                              ...
                              ?>
                              <tr>
                              <td><?php echo $row->id_centro;?></td>
                                <td><?php echo $row->nombre;?></td>
                                <td><?php echo $row->Estado;?></td>
                                <td>
                            <a href="centros/editar.php?id_centro=<?php echo $row->id_centro; ?>" class="btn btn-warning btn-sm">
